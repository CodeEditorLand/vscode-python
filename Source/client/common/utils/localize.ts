...
export namespace Diagnostics {
	...
	export const enableSourceMapsAndReloadVSC = l10n.t(
	...
	export const invalidPythonPathInDebuggerLaunch = l10n.t(
...
export namespace Pylance {
	...
	export const pylanceNotInstalledMessage = l10n.t(
...
export namespace TensorBoard {
	...
	export const launchNativeTensorBoardSessionCodeAction = l10n.t(
		"Launch TensorBoard session",
	);
...
export namespace LanguageService {
	...
	export const startingNone = l10n.t(
	...
	export const downloadFailedOutputMessage = l10n.t(
		"Language server download failed.",
	);

	export const extractionFailedOutputMessage = l10n.t(
		"Language server extraction failed.",
	);

	export const extractionCompletedOutputMessage = l10n.t(
...
export namespace Interpreters {
	...
	export const installingPython = l10n.t(
		"Installing Python into Environment...",
	);
	...
	export const activateTerminalDescription = l10n.t(
	...
	export const restartingTerminal = l10n.t(
		"Restarting terminal and deactivating...",
	);
	...
	export const selectedPythonInterpreter = l10n.t(
...
export namespace InterpreterQuickPickList {
	...
	export const refreshingInterpreterList = l10n.t(
...
export namespace Testing {
	...
	export const cancelUnittestDiscovery = l10n.t(
		"Canceled unittest test discovery",
	);

	export const errorUnittestDiscovery = l10n.t(
		"Unittest test discovery error",
	);

	export const cancelPytestDiscovery = l10n.t(
		"Canceled pytest test discovery",
	);
	...
	export const cancelUnittestExecution = l10n.t(
		"Canceled unittest test execution",
	);

	export const errorUnittestExecution = l10n.t(
		"Unittest test execution error",
	);

	export const cancelPytestExecution = l10n.t(
		"Canceled pytest test execution",
	);

	export const errorPytestExecution = l10n.t("pytest test execution error");

	export const copilotSetupMessage = l10n.t(
...
export namespace CreateEnv {
	export const informEnvCreation = l10n.t(
	...
	export const hasVirtualEnv = l10n.t(
		"Workspace folder contains a virtual environment",
	);

	export const noWorkspace = l10n.t(
		"A workspace is required when creating an environment using venv.",
	);

	export const pickWorkspacePlaceholder = l10n.t(
		"Select a workspace to create environment",
	);

	export const providersQuickPickPlaceholder = l10n.t(
	...
	export namespace Venv {
		...
		export const errorCreatingEnvironment = l10n.t(
			"Error while creating virtual environment.",
		);

		export const selectPythonPlaceHolder = l10n.t(
		...
		export const error = l10n.t(
			"Creating virtual environment failed with error.",
		);

		export const tomlExtrasQuickPickTitle = l10n.t(
			"Select optional dependencies to install from pyproject.toml",
		);
		...
		export const useExistingDescription = l10n.t(
			'Use existing ".venv" environment with no changes to it',
		);
		...
		export const deletingEnvironmentProgress = l10n.t(
			'Deleting existing ".venv" environment...',
		);

		export const errorDeletingEnvironment = l10n.t(
			'Error while deleting existing ".venv" environment.',
		);
	...
	export namespace Conda {
		export const condaMissing = l10n.t(
		...
		export const recreateDescription = l10n.t(
			'Delete existing ".conda" environment and create a new one',
		);

		export const useExisting = l10n.t("Use Existing");

		export const useExistingDescription = l10n.t(
			'Use existing ".conda" environment with no changes to it',
		);
		...
		export const deletingEnvironmentProgress = l10n.t(
			'Deleting existing ".conda" environment...',
		);

		export const errorDeletingEnvironment = l10n.t(
			'Error while deleting existing ".conda" environment.',
		);
	}
