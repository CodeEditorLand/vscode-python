...
export async function createWriterPipe(
	pipeName: string,
	token?: CancellationToken,
): Promise<rpc.MessageWriter> {
...
class CombinedReader implements rpc.MessageReader {
	...
	onPartialMessage: rpc.Event<rpc.PartialMessageInfo> =
...
export async function createReaderPipe(
	pipeName: string,
	token?: CancellationToken,
): Promise<rpc.MessageReader> {
	if (isWindows()) {
		// windows implementation of FIFO using named pipes
