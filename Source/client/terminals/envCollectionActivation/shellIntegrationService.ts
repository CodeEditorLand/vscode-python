...
@injectable()
export class ShellIntegrationDetectionService
	implements IShellIntegrationDetectionService
{
	...
	private async useDataWriteApproach(shellType: TerminalShellType) {
		...
		if (
			...
			shellType === TerminalShellType.powershellCore
		) {
