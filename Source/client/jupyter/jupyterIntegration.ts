...
export class JupyterExtensionIntegration {
	...
	private jupyterPythonPathFunction:
		| ((uri: Uri) => Promise<string | undefined>)
		| undefined;

	private getNotebookUriForTextDocumentUriFunction:
		| ((textDocumentUri: Uri) => Uri | undefined)
		| undefined;
	...
	public getJupyterPythonPathFunction():
		| ((uri: Uri) => Promise<string | undefined>)
		| undefined {
	...
	public getGetNotebookUriForTextDocumentUriFunction():
		| ((textDocumentUri: Uri) => Uri | undefined)
		| undefined {
