...
const filterGlobalExecutable = getFileFilter({
	ignoreFileType: FileType.SymbolicLink,
})!;
...
export async function looksLikeBasicGlobalPython(
	...
	const matchBasic =
		getOSType() === OSType.Windows
			? windows.matchBasicPythonBinFilename
			: posix.matchBasicPythonBinFilename;
