	...
	const testData: IPyenvVersionTestData[] = [
		...
		},
		{
			...
			expectedOutput: {
				pythonVer: "3.3",
				distro: "pypy",
				distroVer: "5.2-alpha1-src",
			},
		},
		{
			input: "pypy3.3-5.2-alpha1",
			expectedOutput: {
				pythonVer: "3.3",
				distro: "pypy",
				distroVer: "5.2-alpha1",
			},
		},
		{
			...
			expectedOutput: {
				pythonVer: "3.3",
				distro: "pypy",
				distroVer: "5.5-alpha-src",
			},
		},
		{
			input: "pypy3.3-5.5-alpha",
			expectedOutput: {
				pythonVer: "3.3",
				distro: "pypy",
				distroVer: "5.5-alpha",
		...
		},
		{
			...
			expectedOutput: {
				pythonVer: "3.5",
				distro: "pypy",
				distroVer: "5.7-beta-src",
			},
		},
		{
			input: "pypy3.5-5.7-beta",
			expectedOutput: {
				pythonVer: "3.5",
				distro: "pypy",
				distroVer: "5.7-beta",
		...
		},
		{
			...
			expectedOutput: {
				pythonVer: "3.5",
				distro: "pypy",
				distroVer: "5.7.1-beta-src",
			},
		},
		{
			input: "pypy3.5-5.7.1-beta",
			expectedOutput: {
				pythonVer: "3.5",
				distro: "pypy",
				distroVer: "5.7.1-beta",
			},
		},
		{
			input: "pypy3.6-7.3.1-src",
			expectedOutput: {
				pythonVer: "3.6",
				distro: "pypy",
				distroVer: "7.3.1-src",
...
suite("Pyenv Shims Dir filter tests", () => {
	...
	test("isPyenvShimDir: valid case", () => {
		assert.deepStrictEqual(
			isPyenvShimDir(path.join(pyenvRoot, "shims")),
			true
		);
	});
