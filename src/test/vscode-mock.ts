...
mockedVSCode.CallHierarchyItem =
	vscodeMocks.vscMockExtHostedTypes.CallHierarchyItem;
...
(mockedVSCode as any).NotebookCellKind =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellKind;
...
(mockedVSCode as any).TypeHierarchyItem =
	vscodeMocks.vscMockExtHostedTypes.TypeHierarchyItem;
(mockedVSCode as any).ProtocolTypeHierarchyItem =
	vscodeMocks.vscMockExtHostedTypes.ProtocolTypeHierarchyItem;
(mockedVSCode as any).CancellationError =
	vscodeMocks.vscMockExtHostedTypes.CancellationError;
(mockedVSCode as any).LSPCancellationError =
	vscodeMocks.vscMockExtHostedTypes.LSPCancellationError;
