...
import {
	PlatformService,
	isWindows,
} from "../client/common/platform/platformService";
...
export class IocContainer {
	...
	constructor() {
		...
		this.serviceManager.addSingletonInstance<ILogOutputChannel>(
			ILogOutputChannel,
			stdOutputChannel
		);
		...
		this.serviceManager.addSingletonInstance<ITestOutputChannel>(
			ITestOutputChannel,
			testOutputChannel
		);
	...
	public registerMockProcessTypes(): void {
		...
		const processService = new MockProcessService(
			new ProcessService(process.env as any)
		);
