...
export function assertVersionsEqual(
	actual: PythonVersion | undefined,
...
export function assertEnvEqual(
	actual: PythonEnvInfo | undefined,
	expected: PythonEnvInfo | undefined
): void {
...
export function assertEnvsEqual(
	...
	actualEnvs = actualEnvs.sort((a, b) =>
...
export function assertBasicEnvsEqual(
	actualEnvs: BasicEnvInfo[],
	expectedEnvs: BasicEnvInfo[]
): void {
