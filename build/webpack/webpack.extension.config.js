...
const config = {
	...
	entry: {
		...
		"registryKeys.worker":
			"src/client/pythonEnvironments/common/registryKeys.worker.ts",
		"registryValues.worker":
			"src/client/pythonEnvironments/common/registryValues.worker.ts",
	},
	devtool: "source-map",
	node: {
		__dirname: false,
	...
	resolve: {
		extensions: [".ts", ".js"],
		plugins: [
			new tsconfig_paths_webpack_plugin.TsconfigPathsPlugin({
